...
const COPY = {
  ...
  heading: 'Se você leu até aqui, é porque algo aí dentro',
  headingEm: 'te chamou.',
  subtitle: 'A primeira sessão é um presente meu pra você. Sem cobrança, sem compromisso.',
  ctaText: 'Quero agendar minha sessão com a Marisa',
}
// ════════════════════════════════════════════════════════════════════
