...
// ════════════════════════════════════════════════════════════════════
const COPY = {
  callout: 'VOCÊ CARREGA TUDO SOZINHA?',
  h1: 'Você não perdeu sua vida.',
  h1Em: 'Ela está esperando você decidir recuperá-la.',
  subtitle: 'Acompanhamento online pra mulher madura presa em ciclo e cansada de tentar tudo sozinha.',
  ctaPrimary: 'Quero agendar minha sessão',
  ctaSecondary: 'a primeira sessão é um presente da Marisa',
}
// ════════════════════════════════════════════════════════════════════
