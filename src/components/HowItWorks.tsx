...
const COPY = {
  ...
  heading: 'Como funciona o atendimento comigo',
  steps: [
    {
      title: 'Você agenda sua primeira sessão',
      body: 'Pelo botão da página ou pelo WhatsApp. A primeira sessão é um presente meu pra você. Sem cobrança.',
    },
    {
      title: 'A gente conversa online, sem fórmula pronta',
      body: 'Uma hora só pra você. Eu escuto, eu acolho, eu te ajudo a ver o que está embaixo da dor. Você decide se quer continuar.',
    },
    {
      title: 'Se fizer sentido, a gente segue juntas',
      body: 'No seu ritmo, no formato que cabe na sua vida. Sem prazo cravado, sem promessa falsa.',
    },
  ],
  note: 'Sem pressão, sem assinatura, sem amarra. Você decide cada passo.',
