...
const COPY = {
  eyebrow: 'quem sou eu',
  heading: 'Eu não atravessei isso de fora.',
  headingEm: 'Eu saí do mesmo lugar.',
  paragraphs: [
    'Eu estive presa por anos em ciclos de relacionamento que me machucavam. Saí do primeiro casamento e, anos depois, entrei num segundo, achando que era diferente. Quando me dei conta, estava vivendo o mesmo padrão de novo. Ansiedade, depressão, sensação de estar perdendo quem eu era.',
    'Aos 50 anos, eu dei um basta. Saí. E pela primeira vez não senti que tinha perdido alguma coisa. Senti que tinha recuperado a minha vida.',
    'Comecei a estudar terapia pra entender por que eu repetia esse padrão. Hoje eu acompanho mulheres maduras com perdas acumuladas, presas em ciclos, com a vida desmoronando em várias frentes ao mesmo tempo. Eu não atravessei isso de fora. Eu saí do mesmo lugar.',
  ],
  transition: 'Se você reconhece nessas linhas algo do que vive, marca a primeira conversa comigo.',
