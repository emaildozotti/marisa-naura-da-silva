...
// Cliente: Marisa Naura da Silva
// Fonte: briefing-structured.json + lp-copy.md
// ════════════════════════════════════════════════════════════════════

export const SITE = {
  nomeCompleto: 'Marisa Naura da Silva',
  nomeCurto: 'Marisa',
  iniciais: 'MN',
  especialidadeCurta: 'Terapia para Mulheres',
  credenciais: 'Terapeuta | Atendimento 100% Online\n4 anos de prática clínica',
  crp: 'Terapeuta',
